...
class mod_activityshortcut_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $activitylist = activityshortcut_get_activities_list();
        
        $mform->addElement('select', 'relatedactivity', get_string('relatedactivity', $plugin),$activitylist);
